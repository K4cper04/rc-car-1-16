...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_CS_Pin|OLED_DC_Pin|OLED_RES_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RED_BUTTON_Pin BLUE_BUTTON_Pin */
  GPIO_InitStruct.Pin = RED_BUTTON_Pin|BLUE_BUTTON_Pin;
